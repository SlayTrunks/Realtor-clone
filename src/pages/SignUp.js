        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form>
            ...
            {showPassword ? <AiFillEyeInvisible onClick={handleToggleEye} className='absolute right-3 top-3 text-xl cursor-pointer'  /> : <AiFillEye onClick={handleToggleEye} className='absolute right-3 top-3 text-xl cursor-pointer' />} 
              ...
              <button type="submit" className="w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium hover:bg-blue-700 uppercase rounded shadow-md transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800 ">Sign Up</button>
          <div className="my-4">
